...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="../htmlassets/img/icon_192.png" />
...
<body>
    <div class="list">
        <ul>
            <li>PHP myAdmin : <a href="http://garam1.dothome.co.kr/myadmin">myadmin</a></li> <br>
            ...
            <li>로그아웃: <a href="login/logout.php">loginSave.php</a></li>
